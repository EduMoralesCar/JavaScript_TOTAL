...
function consultarAPI(ciudad, pais) {
  ...
  const appId = '20063da8cb9725741c2c3c541aaf69ef'; // Reemplazar con tu API key
  let url = `https://api.openweathermap.org/data/2.5/weather?q=${ciudad},${pais}&appid=${appId}&units=metric&lang=es`;
